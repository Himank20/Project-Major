...
<body>
    ...
    <%
        ...
        Statement stmt=con.createStatement();  
            ResultSet rs=stmt.executeQuery("select* from student inner join student3 on student.Scholar_NO=student3.Scholar_NO inner join student4 on student.Scholar_NO=student4.Scholar_NO where student.Scholar_NO='"+s1+"'");
            while(rs.next()){
                for(int i=0;i<=35;i++){
